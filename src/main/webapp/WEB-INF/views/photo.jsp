...
<body>
    ...
    <div class="content-block">
        ...
        You have ${photoUrls.size()} photo in album <br>
        <c:if test = "${photoUrls.size() > 0}">
        <ol>
            <c:forEach items="${photoUrls}" var="photoUrl">
                <img alt="Image not displayed" src="${photoUrl}" border="2" height="200" width="200" />
                <!-- TODO: resize preserving ratio with height 200 -->
                <!-- TODO: hover to zoom in, click to view full size -->
            </c:forEach>
        </ol>
        </c:if>
        
        <form:form modelAttribute="uploadItem" action="${albumId}/save-photo" method="post" enctype="multipart/form-data">
            <fieldset>
                ...
                <p>
                    ...
                    <form:input id="files" path="files" type="file" multiple="multiple" />
                    <form:errors path="files" cssClass="error" />
                </p>
                <p id="buttons">
                    <input id="reset" type="reset"> 
                    <input id="submit" type="submit" value="Add Photos">
                </p>
            </fieldset>
        </form:form>
